...
const Header = () => {
  return (
    <section className="relative w-full h-screen bg-[url('/assets/images/campus.jpg')] bg-cover bg-center bg-no-repeat">
      <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center text-white text-center px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">College Hostel Info</h1>
        <p className="text-lg md:text-xl mb-8 max-w-2xl">Find the ideal accommodation for your college journey</p>
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <Link to="/hostel-admin" className="bg-yellow-700 hover:bg-yellow-800 px-6 py-2 rounded text-white min-w-[120px]">About</Link>
